...
### Added
- **Find References** (`Tools > TechArt Tools > Find References`, also in the Asset context menu): finds every scene / prefab / material / asset file that references the selected asset (matched by GUID). Open scenes directly from the results.
